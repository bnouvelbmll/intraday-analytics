...
class TestDenseAnalytics(unittest.TestCase):
    ...
    def test_adaptive_mode_with_failures(self):
        ...
        # Verify log message
        self.assertTrue(any("Could not determine continuous intervals" in o for o in cm.output))
        self.assertTrue(any("2" in o for o in cm.output)) # Listing ID 2 should be in the log
