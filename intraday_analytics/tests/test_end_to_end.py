...
class TestEndToEnd(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = AnalyticsConfig(
            ...
            FINAL_OUTPUT_PATH_TEMPLATE=os.path.join(self.temp_dir, "final_{start_date}_{end_date}.parquet"),
    ...
    def test_run_pipeline(self, mock_storage_paths, mock_estimator_cls, mock_get_files, mock_process_interval, mock_scan_parquet):
        ...
        expected_out = os.path.join(self.temp_dir, "final_2025-01-01_2025-01-02.parquet")
