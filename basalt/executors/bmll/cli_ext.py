...
def bmll_run(
    ...
    **kwargs,
    ...
    """
    Submit a BMLL instance job that runs the standard basalt CLI.
    """
...
def bmll_install(
    ...
    **kwargs,
    ...
    """
    Install a cron-triggered BMLL instance job.
    """
    return bmll_run(
...
class BMLLCLI:
    @staticmethod
    def run(*args, **kwargs):
        return bmll_run(*args, **kwargs)

    @staticmethod
    def install(*args, **kwargs):
        return bmll_install(*args, **kwargs)
