...
def _default_bootstrap_content(project_root: Path, pythonpath: list[str]) -> str:
    ...
    return "\n".join(
        [
            ...
            "echo \"[basalt bootstrap] waiting for /home/bmll/user mount (timeout=${MOUNT_WAIT_SECONDS}s, step=${MOUNT_WAIT_STEP}s)\"",
            "elapsed=0",
            "until [ -d /home/bmll/user ] && mount | grep -q '/home/bmll/user'; do",
            ...
            "done",
            "echo \"[basalt bootstrap] post-wait /home/bmll/user listing:\"",
            "ls -la /home/bmll/user 2>/dev/null || true",
