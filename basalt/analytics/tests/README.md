...
- Avoid end-to-end pipeline concerns; those belong to `basalt/tests/`.

Framework-level tests (pipeline execution, IO targets, config wiring, Dagster integration, etc.) remain in `basalt/tests/`.
